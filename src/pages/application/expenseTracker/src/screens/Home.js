...
const Home = () => {
  ...
  function processCategoryDataToDisplay() {
    ...
    let chartData = categories.map((item) => {
      ...
      // console.log('confirmExpenses: ', confirmExpenses);
  ...
  function renderChart() {
    ...
    // console.log('renderChart totalExpenseCount: ', totalExpenseCount);
    ...
    return (
      <View
        ...
        <VictoryPie
          ...
          radius={({datum}) => {
            // console.log('radius datum: ', datum);
            return selectedCategory && selectedCategory.name == datum.name
              ? SIZES.width * 0.4
              : SIZES.width * 0.4 - 10;
          }}
          innerRadius={70}
  ...
  function setSelectCategoryByName(name) {
    ...
    // console.log('setSelectCategoryByName category: ', category);
